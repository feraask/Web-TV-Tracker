<?php
	...
	return $recommendations_query = mysql_query("SELECT DISTINCT(ratings_dist.movie_id) AS id, ratings_dist.title as title, ratings_dist.series_years AS series_years, SQRT(ratings_distance+POW((1 - num_genres_in_top/num_genres_in_show)*10, 2)) AS euclid_dist
						FROM
									(
